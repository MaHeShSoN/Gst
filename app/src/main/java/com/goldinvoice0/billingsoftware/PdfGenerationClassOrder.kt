...
//    ): File {
//
//        val advanceGold = order.advancedGoldText
//        val advancePayment = order.advancedPaymentText
//
//        val l0 =
//            "Term And Condition"
//        val l1 =
...
//            mainListY - (itemList.size - 1).toFloat() * 15f - 13f - 6f
//
//        printListHorizontal(itemList, contentStream, mainListY - 13f, document)
//
//        drawRectangle(
//            contentStream,
//            20f,
//            lastMainListItemY,
//            pageWidth - 40f,
//            (itemList.size).toFloat() * 15f + 3.5f,
//            AWTColor.BLACK
//        )
//
//
...
//        val rectHeight = (numberOfLines * lineSpacing) + 20f  // Adjusted height for content + padding
...
//
//            // Draw item details
//            drawText(contentStream, orderItem.itemName, 63f, yPosition, 12f, AWTColor.BLACK)
//            drawText(
//                contentStream,
//                orderItem.itemWeight.toString(),
//                173f,
//                yPosition,
//                12f,
//                AWTColor.BLACK
